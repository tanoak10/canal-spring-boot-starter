...
import io.github.tanoak10.starter.canal.client.exception.CanalClientException;
                ...
                .forEach(entry -> {
                    ...
                    try {
                        ...
                        if (logger.isDebugEnabled()) {
                            logger.debug("{}: Get message from canal server >>>>> eventType:{},rowData:{} ", Thread.currentThread().getName(), eventType,rowData );
                        }
